...
// Diag helper
function logd(msg){ const d=document.getElementById('diag'); if(d){ d.textContent = '[v7.2.1] ' + msg; } console.log('[v7.2.1]', msg); }
...
// Firebase
if(!window.firebase){ logd('Firebase non caricato'); }
...
logd('Startup: urlGameId=' + urlGameId + ' urlHostId=' + urlHostId + ' saved=' + JSON.stringify(saved));
